...
function openPopup() {
  ...
  {
  question: "2. my_dict = {'a': 1, 'b': 2, 'c': 3}\nresult = my_dict.get('d', my_dict.pop('b'))\nWhat will be the value of result and what will my_dict contain after executing this code?",
  ...
  {
  question: "3. my_list = [1, 2, 3, 4]\nnew_list = my_list[1:-1]\nnew_list[0] = 5\nfinal_list = my_list + new_list\nWhat will be the value of final_list after executing this code?",
  options: ["[1, 2, 3, 4, 5, 3]",
  "[1, 5, 3, 4, 5, 3]",
  "[1, 2, 3, 4, 2, 3]",
  "[1, 2, 3, 4, 5]"],
  ...
  {
  question: "7.Consider the base cases in the provided Fibonacci function (if n <= 0: return 0 and elif n == 1: return n)\nWhat is their primary purpose in the recursive process?",
