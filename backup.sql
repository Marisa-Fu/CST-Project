...
--
-- Host: localhost    Database: trivia_game
-- ------------------------------------------------------
...
CREATE TABLE `quiz_results` (
  ...
  CONSTRAINT `quiz_results_chk_1` CHECK ((`level` between 1 and 3))
...
CREATE TABLE `transactions` (
  ...
  `user_id` int DEFAULT NULL,
  `type` enum('earn','spend','life_purchase','life_loss') NOT NULL,
  `amount` int NOT NULL,
  `timestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dump completed on 2025-05-05 17:58:09
